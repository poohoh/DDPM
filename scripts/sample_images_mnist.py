...
def create_argparser():
    ...
    parser.add_argument("--model_path", type=str, default="/media/sda1/junha/DDPM/mnist_ckpt/DDPM-ddpm-2024-09-23-14-09-iteration-44000-model.pth")
    parser.add_argument("--save_dir", type=str, default="/media/sda1/junha/DDPM/sample_result/mnist")
